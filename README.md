...
- **StockMaster Agent**: A specialized agent leveraging Finnhub APIs for intraday U.S. stock trading. Set `FINNHUB_API_KEY` and instantiate `StockMaster` to receive real-time momentum-based trade suggestions.
